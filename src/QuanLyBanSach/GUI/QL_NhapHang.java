...
//	}
	...
	private void chonSanPhamNhap() {
        ...
        if(txt_donGia.getText().isEmpty() || txt_donGia.getText().matches("[a-zA-Z]+")){
            new MyDialog("Vui lòng nhập giá sản phẩm cần nhập hoặc gia nhập bị sai!", MyDialog.ERROR_DIALOG);
            return;
        }
